 ...
 * 算法。
 ******************************************************************************/
public class MD5AndHashkeyBean {
	/*
	 ...
	 */
	public String encoderByType(String pwd,String type) {
		String pwdAfter = "";//加密后密码
		try {
			MessageDigest md = MessageDigest.getInstance(type);//SHA 或者 MD5
			BASE64Encoder  base = new BASE64Encoder ();
		    pwdAfter = base.encode(md.digest(pwd.getBytes("utf-8")));
		} catch (Exception e) {
			e.printStackTrace();
		}    
	    return pwdAfter;
	 ...
	 * @param len 长度：16位或者32位
	 * @return
	 */
	public String md5Encoder(String sourceStr,Integer len){
...
/*	public static void main(String args[]) {
		MD5AndHashkeyBean m = new MD5AndHashkeyBean();	
		System.out.println(m.encoderByType("admin:123456","MD5"));
		try {
			MessageDigest md = MessageDigest.getInstance("MD5");
			System.out.println(md.digest("admin:123456".getBytes()));
		} catch (NoSuchAlgorithmException e) {
